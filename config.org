...
#+begin_src emacs-lisp
  ...
  ;; (defvar essl/frame-transparency '(90 . 90))
...
** Code folding
*** Hideshow
[[[https://www.gnu.org/software/emacs/manual/html_node/emacs/Hideshow][Hideshow manual]]]
:hideshow-minormode:
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  (use-package ebib
    ...
    :init
    (setq
     ebib-bib-search-dirs essl/ebib-search-dir
     ...
     ebib-preload-bib-files essl/ebib-bibtex-files
...
#+begin_src emacs-lisp
  (use-package pdf-tools
    ...
    (define-key pdf-view-mode-map (kbd "y") 'pdf-annot-add-squiggly-markup-annotation)
    (define-key pdf-view-mode-map (kbd "_") 'pdf-annot-add-strikeout-markup-annotation)
    ...
    (setq pdf-annot-default-annotation-properties
          '((t
            ...
            (strike-out
             (color . "red"))))
    (setq pdf-annot-color-history '("khaki1" "powder blue" "thistle"
                                      "DarkSeaGreen2" "light salmon" "snow2"
                                      "dark cyan" "orange red"))
    )
#+end_src
* Org-mode
** Aspect
...
#+begin_src emacs-lisp
  (use-package org-noter
    ...
    :config
    '(org-noter-notes-search-path essl/org-noter-dir)
    )
#+end_src
:END:
** Org-reveal
...
#+begin_src emacs-lisp
  (use-package org-ref
    ...
    (custom-set-faces
     '(org-ref-cite-face ((t (:inherit link :foreground nil)))))
...
#+begin_src emacs-lisp
  (use-package org-roam
    ...
    :custom
    (org-roam-directory essl/org-roam-dir)
...
** Spelling
*** Hunspell
Source: [[https://tex.stackexchange.com/questions/166681/changing-language-of-flyspell-emacs-with-a-shortcut][link]]
