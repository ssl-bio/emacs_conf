#+STARUP: hidestars
* Personal information                         :commented:
:info:
#+BEGIN_SRC emacs-lisp :results silent
  ;; (setq user-full-name "Saul SL"
        ;; user-mail-address "ssl@example.com")
#+END_SRC
:END:
* Setup custom file
...
:install-packages:
#+begin_src emacs-lisp :results silent
  (setq ipackages '(magit ox-gfm org auctex ebib ess helm-R olivetti unfill format-all))
  ;; install themes 
...
:install-themes:
#+begin_src emacs-lisp :results silent
  (setq ithemes '(leuven-theme darktooth-theme chyla-theme))
  ;; install themes 
...
:font:
#+begin_src emacs-lisp :results silent
  (set-face-attribute 'default nil :font "Courier New" :height essl/default-font-size)

  ;; Set the fixed pitch face
  (set-face-attribute 'fixed-pitch nil :font "Courier New" :height essl/default-font-size)

  ;; Set the variable pitch face
  (set-face-attribute 'variable-pitch nil :font "Verdana" :height essl/default-variable-font-size)
#+end_src
:END:
*** Font scaling
:font-scaling:
...
#+begin_src emacs-lisp :results silent
  ...
  (dolist (face '((org-level-1 . 1.2)
                  ...
                  (org-level-7 . 1.1)
                  (org-level-8 . 1.1)))
    (set-face-attribute (car face) nil :font "Courier New" :weight 'regular :height (cdr face))
    )
...
#+begin_src emacs-lisp :results silent
  (use-package org-ref
    ...
    :config
    (setq bibtex-completion-bibliography '("~/Documents/Referencias/JabRef/Working.bib")
