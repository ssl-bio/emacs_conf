...
#+begin_src emacs-lisp
  ...
  ;; Editing options
  (keymap-global-set "C-x h" 'mark-whole-buffer) ;; mark whole buffer as helm
...
- Independent: flatland darktooth-theme timu-spacegrey mellow-theme warm-night-theme
**** Light themes
- built-in: dichromacy
...
- almost-mono-themes: almost-mono-cream almost-mono-gray
  - Independent: monotropic eink nord poet
*** Install themes
:install-themes:
#+begin_src emacs-lisp
  ...
  (setq ithemes '(ef-themes
                  modus-themes nord-theme
                    ...
                    almost-mono-themes monotropic-theme eink-theme poet-theme
                    suscolors-theme))
...
#+begin_src emacs-lisp
  ...
  (setq my-dark-themes '("ef-melissa-dark" "ef-elea-dark" "timu-spacegrey"
                         "flatland" "darktooth" "ef-cherie" "suscolors"))
  (setq my-light-themes '("dichromacy" "modus-operandi-tritanopia" "ef-day"
                          "ef-tritanopia-light" "ef-cyprus"
                          "ef-melissa-light" "ef-maris-light"))
  (setq my-write-themes '("almost-mono-cream" "almost-mono-gray"
                            "monotropic" "eink" "nord" "poet"))
  ;; Cycle through themes
