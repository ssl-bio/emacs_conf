...
:install-packages:
#+begin_src emacs-lisp :results silent
  (setq ipackages '(magit ox-gfm org auctex ebib ess helm-R olivetti unfill format-all poly-R poly-markdown))
  ;; install packages 
...
#+begin_src emacs-lisp :results silent
  (use-package org-ref
    ...
    :config
    (setq bibtex-completion-bibliography '("~/Documents/Referencias/Bibtex/Working.bib")
