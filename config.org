...
- If statements are used to set variables for
  ...
  3) Font size
     - One for a computer with small screen size (15'' searches for the folder =Documents=)
     - Another for a computer with a large (24'' alternative to the above)
  4) Path to [[https://revealjs.com/][Reveal.js]] installation (Presentations)
     - Two different paths
...
#+begin_src emacs-lisp
  ...
  (let ((folder-exists (file-directory-p "~/Documents")))
    (if folder-exists
        (progn
          (setq font-regular 130)
          (setq font-medium 150)
          (setq font-large 170))
      (progn
        (setq font-regular 105)
        (setq font-medium 120)
        (setq font-large 135))))
...
#+begin_src emacs-lisp
  ...
  (setq my-dark-themes '("ef-melissa-dark" "ef-elea-dark" "misterioso"
                         "flatland" "darktooth" "mellow" "suscolors"
                         "warm-night"))
  (setq my-light-themes '("dichromacy" "modus-operandi-tinted" "ef-day"
...
#+begin_src emacs-lisp
  (use-package fontaine
    ...
    (setq fontaine-presets
          '(
            (regular
             :default-height font-regular)
            (medium
             :default-height font-medium)
            (large
             :default-height font-large)
            (t
...
#+begin_src emacs-lisp
  (use-package eshell-bookmark
    :straight (eshell-bookmark :type git 
                               :flavor melpa 
                               :host github 
