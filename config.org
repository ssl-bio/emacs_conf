...
- Independent: flatland darktooth-theme timu-spacegrey mellow-theme warm-night-theme jazz-theme blackboard-theme arjen-theme deep-blue-theme desert-theme  railscast robin-hood suscolors-theme
**** Light themes
- built-in: dichromacy
...
#+begin_src emacs-lisp
  ...
  (setq ithemes '(ef-themes
                  modus-themes nord-theme
                    ...
                    majapahit-themes jazz-theme suscolors-theme))
...
#+begin_src emacs-lisp
  (straight-use-package
   '(replace-colorthemes
     ...
     :files ("andreas-theme.el" "arjen-theme.el" "kingsajz-theme.el"
             "gtk-ide-theme.el" "deep-blue-theme.el" "late-night-theme.el"))
   )
#+end_src
:END:
...
#+begin_src emacs-lisp
  ...
  (setq my-dark-themes '("suscolors" "kingsajz" "ef-melissa-dark" "flatland"
                         "darktooth"  "jazz"  "ef-cherie"
                         "arjen" "deep-blue"))
  (setq my-light-themes '("dichromacy" "andreas" "gtk-ide"
